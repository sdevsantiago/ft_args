...
# 	@$(PRINT) "$(GREEN)$(EMOJI_CHECK) $(BONUS_NAME) ready. $(RESET)"
...
LIBS			= $(LIBFT_NAME) $(FT_PRINTF_NAME) $(GET_NEXT_LINE_NAME)
LIBS_INCLUDE	= -I $(LIBFT_INCLUDE_PATH) -I $(FT_PRINTF_NAME) -I $(GET_NEXT_LINE_INCLUDE_PATH)
LIBS_PATH		= lib
...
# GET_NEXT_LINE_NAME			= $(GET_NEXT_LINE_PATH)/get_next_line_bonus.a
